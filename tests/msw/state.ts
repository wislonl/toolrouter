...
const createDefaultInstalledSkills = (): InstalledSkill[] => [
  {
    id: "mock-skill",
    name: "Mock Skill",
    description: "A managed skill fixture",
    directory: "mock-skill",
    apps: {
      claude: true,
      codex: true,
      gemini: false,
...
export const getInstalledSkills = () =>
  deepClone(installedSkillsState) as InstalledSkill[];

export const setInstalledSkills = (skills: InstalledSkill[]) => {
  installedSkillsState = deepClone(skills) as InstalledSkill[];
};
