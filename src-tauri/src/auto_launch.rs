...
/// 将 `/path/to/ToolRouter.app/Contents/MacOS/ToolRouter` 转换为 `/path/to/ToolRouter.app`
#[cfg(target_os = "macos")]
...
mod tests {
    ...
    fn test_get_macos_app_bundle_path_valid() {
        let exe_path =
            std::path::Path::new("/Applications/ToolRouter.app/Contents/MacOS/ToolRouter");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from("/Applications/ToolRouter.app"))
        );
    }
    ...
    fn test_get_macos_app_bundle_path_with_spaces() {
        let exe_path =
            std::path::Path::new("/Users/test/My Apps/ToolRouter.app/Contents/MacOS/ToolRouter");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from(
                "/Users/test/My Apps/ToolRouter.app"
            ))
        );
    }
