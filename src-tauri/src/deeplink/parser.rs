...
//!
//! Parses akswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a akswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// akswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "akswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'akswitch', got '{scheme}'"
        )));
    }
